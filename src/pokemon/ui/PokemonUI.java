...
//                    System.out.println(table.getColumn(i-1).getWidth());
//                    System.out.println(p.getName().length());
//                    if (p.getName().length() * 75 > table.getColumn(i-1).getWidth()) {
//                        table.getColumn(i-1).setWidth(p.getName().length() * 75);
...
//	{
//	    for (TableColumn tc : table_.getColumns()) {
